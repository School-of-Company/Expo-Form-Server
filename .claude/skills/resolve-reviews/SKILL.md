...
**Rule priority**: `.claude/skills/nestjs-arch/**` > `.claude/skills/api-design/SKILL.md` > everything else.
If a root `CLAUDE.md` or `AGENTS.md` is added later it outranks both — check for one before relying on
this order.
